 ...
 */
@Component
public class ActiveUserPushTask extends com.jdb.dmp.task.base.PushTask {
    Logger logger = LoggerFactory.getLogger(ActiveUserPushTask.class);
    @Value("${layer.file.dir.active}")
    String layerFileDir;
...
//        Result rt = hBaseLayerTable.get(get);
        ...
        for (; i < sLen; i++) {
            ...
            if (sResult) {
                Marker marker = append("uuid", jdbUser.getUuid()).and(append("stragegy", i));
    ...
    public void instanceStrategyList() {
        ...
        FriendBorrowAmountA2 friendBorrowAmountA2 = new FriendBorrowAmountA2(0, 10, ConditionJudgeType.MEET.getValue());

        FriendCreditAmountA5 friendCreditAmountA5 = new FriendCreditAmountA5(0, 10, ConditionJudgeType.MEET.getValue());
