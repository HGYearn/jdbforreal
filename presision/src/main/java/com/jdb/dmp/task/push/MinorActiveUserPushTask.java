 ...
 */
@Component
public class MinorActiveUserPushTask extends com.jdb.dmp.task.base.PushTask {
    @Value("${layer.file.dir.minoractive}")
    String layerFileDir;
    ...
    String messageForS2 = "您的好友%s借出款项到期收回, 收益率高达年化%.1f%%,直投熟人更高明！";
    String messageForS3 = "您的好友%s今天投资了一笔熟人借款, 年化收益高达%.1f%%, 直投熟人更高明";
...
//                        set(getPushedSetKeyPrefix() + jdbUser.getUuid(), jdbUser.getUuid());
//                getJedisPool().getResource().expire(getPushedSetKeyPrefix() + jdbUser.getUuid(), 86400*5);
