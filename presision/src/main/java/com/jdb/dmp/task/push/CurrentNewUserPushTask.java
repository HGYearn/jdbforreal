 ...
 */
@Component
public class CurrentNewUserPushTask extends PushTask {
    @Value("${layer.file.dir.current}")
    String layerFileDir;
    ...
    public void process(JobExecutionMultipleShardingContext context) {
        try {
            logger = LoggerFactory.getLogger(CurrentNewUserPushTask.class);
            ...
            while (sendThreads > 0) {
                PushSenderThread pushSender = new PushSenderThread(CurrentNewUserPushTask.class);
    ...
    public void initPushConfigurationList() {
        ...
        builder.newInstance().setContent(messageForS1).setDescription(messageForS1).setGroup(MinorActiveUserPushTask.class.getName() + "_1")
        ...
        builder.newInstance().setContent(messageForS2).setDescription(messageForS2)
                .setGroup(MinorActiveUserPushTask.class.getName() + "_2")
                .setTitle(pushTitle).setSubtype(104);
        pushConfigurationList.add(builder.build());
    }
    /**
