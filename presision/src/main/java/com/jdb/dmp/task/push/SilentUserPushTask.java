 ...
 */
@Component
public class SilentUserPushTask extends com.jdb.dmp.task.base.PushTask {
    Logger logger = LoggerFactory.getLogger(SilentUserPushTask.class);
    @Value("${layer.file.dir.silent}")
    String layerFileDir;
