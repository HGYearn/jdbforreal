 ...
 */
@Component
public class LossUserPushTask extends com.jdb.dmp.task.base.PushTask {
    Logger logger = LoggerFactory.getLogger(LossUserPushTask.class);
    @Value("${layer.file.dir.loss}")
    String layerFileDir;
