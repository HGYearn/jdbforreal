 ...
 */
@Component
public class NearSilentUserPushTask extends com.jdb.dmp.task.base.PushTask {
    Logger logger = LoggerFactory.getLogger(NearSilentUserPushTask.class);
    @Value("${layer.file.dir.nearsilent}")
    String layerFileDir;
